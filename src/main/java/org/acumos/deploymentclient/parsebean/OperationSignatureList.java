...
public class OperationSignatureList implements Serializable {
  private static final long serialVersionUID = -6436344519431883582L;
   ...
   * @param connectedTo This is the connected to for an operation signature.
   */
  public OperationSignatureList(
      OperationSignature operationSignature, ArrayList<ConnectedTo> connectedTo) {
    super();
  ...
  public String toString() {
    ...
    return "OperationSignatureList [operationSignature="
        + operationSignature
        + ", connectedTo="
        + connectedTo
        + "]";
