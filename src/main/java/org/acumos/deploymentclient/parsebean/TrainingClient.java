...
public class TrainingClient implements Serializable {
  ...
  private static final long serialVersionUID = 6803294465759068422L;

  /** No args constructor for use in serialization */
  public TrainingClient() {}

  /**
   * @param dataBrokers This is the databroker
   * @param containerName This is is the container name
   * @param image This is the image
   * @param mlModels This is the mlmodels to train.
   */
  public TrainingClient(
      String containerName, String image, List<DataBroker> dataBrokers, List<MlModel> mlModels) {
    super();
