...
public class DeploymentBean implements Serializable {
	...
	/*
	 * public String getDockerProxyHost() { return dockerProxyHost; } public void
	 * setDockerProxyHost(String dockerProxyHost) { this.dockerProxyHost =
	 * dockerProxyHost; } public String getDockerProxyPort() { return
	 * dockerProxyPort; } public void setDockerProxyPort(String dockerProxyPort) {
