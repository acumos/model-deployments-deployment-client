...
public class SwaggerConfiguration {
	...
	private ApiInfo apiInfo() {
		final String version = DeploymentClientApplication.class.getPackage().getImplementationVersion();
		ApiInfo apiInfo = new ApiInfo("Acumos deployment client REST API", "Operations for deployment client.", // description
