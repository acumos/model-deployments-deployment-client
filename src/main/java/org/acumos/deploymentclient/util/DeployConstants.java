...
public class DeployConstants {
  ...
  public static final String CMNDATASVC_CMNDATASVCENDPOINTURL_PROP =
      "cmndatasvc.cmndatasvcendpointurl";
  ...
  public static final String JENKINS_JOBSIMPLE_PROP = "jenkins.job.simple";
  public static final String JENKINS_JOBCOMPOSITE_PROP = "jenkins.job.composite";
  public static final String JENKINS_JOBNIFI_PROP = "jenkins.job.nifi";
  ...
  public static final String SITE_VERIFICATION_KEY="k8sCluster";
