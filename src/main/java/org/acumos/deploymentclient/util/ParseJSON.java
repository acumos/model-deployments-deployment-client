...
public class ParseJSON {
  ...
  public DataBrokerBean getDataBrokerContainer(String jsonString) throws Exception {
    ...
    try {
      ...
      JSONArray nodes = (JSONArray) jo.get(DeployConstants.NODES);
      int nodeLength = -1;
      int dataBrokerVal = -1;
      ...
      if (nodes != null) {
        ...
        while (itr3.hasNext()) {
          ...
          while (itr1.hasNext()) {
            ...
            if (pair != null && pair.getKey() != null && pair.getValue() != null) {
              ...
              if (key != null && key.equalsIgnoreCase(DeployConstants.NODE_TYPE)) {
                nodeType = (String) pair.getValue();
                if (nodeType != null && nodeType.equalsIgnoreCase(DeployConstants.DATA_BROKER)) {
        ...
        if (dataBrokerList != null && dataBrokerList.size() > 0) {
          for (Integer num : dataBrokerList) {
            ...
            if (jsonObject != null) {
              if (jsonObject.get(DeployConstants.CONTAINER_NAME) != null) {
                containerName = (String) jsonObject.get(DeployConstants.CONTAINER_NAME);
              }
              if (jsonObject.get(DeployConstants.NODE_TYPE) != null) {
                nodeType = (String) jsonObject.get(DeployConstants.NODE_TYPE);
              }
              if (jsonObject.get(DeployConstants.IMAGE) != null) {
                image = (String) jsonObject.get(DeployConstants.IMAGE);
              }
              if (jsonObject.get(DeployConstants.PROTO_URI) != null) {
                protoUri = (String) jsonObject.get(DeployConstants.PROTO_URI);
                dataBrokerBean.setProtobufFile(protoUri);
              }
              if (jsonObject.get(DeployConstants.DATA_BROKER_MAP) != null) {
                dataBrokerObject = (JSONObject) jsonObject.get(DeployConstants.DATA_BROKER_MAP);
                if (dataBrokerObject != null) {
                  if (dataBrokerObject.get(DeployConstants.DATA_BROKER_TYPE) != null) {
                    String dataBrokerType =
                        (String) dataBrokerObject.get(DeployConstants.DATA_BROKER_TYPE);
                    log.debug("dataBrokerType " + dataBrokerType);
                    if (dataBrokerType != null
                        && dataBrokerType.equalsIgnoreCase(DeployConstants.CSV_FILE_NAME)) {
                      dataBrokerMap.setDataBrokerType(
                          (String) dataBrokerObject.get(DeployConstants.DATA_BROKER_TYPE));
                    } else {
                      dataBrokerBean = null;
                      break;
                  ...
                  if (dataBrokerObject.get(DeployConstants.SCRIPT) != null) {
                    dataBrokerMap.setScript((String) dataBrokerObject.get(DeployConstants.SCRIPT));
                  }
                  if (dataBrokerObject.get(DeployConstants.TARGET_SYSTEM_URL) != null) {
                    dataBrokerMap.setTargetSystemUrl(
                        (String) dataBrokerObject.get(DeployConstants.TARGET_SYSTEM_URL));
                  }
                  if (dataBrokerObject.get(DeployConstants.LOCAL_SYSTEM_DATA_FILE_PATH) != null) {
                    dataBrokerMap.setLocalSystemDataFilePath(
                        (String) dataBrokerObject.get(DeployConstants.LOCAL_SYSTEM_DATA_FILE_PATH));
                  }
                  if (dataBrokerObject.get(DeployConstants.FIRST_ROW) != null) {
                    dataBrokerMap.setFirstRow(
                        (String) dataBrokerObject.get(DeployConstants.FIRST_ROW));
                  }
                  if (dataBrokerObject.get(DeployConstants.CSV_FILE_FIELD_SEPARATOR) != null) {
                    dataBrokerMap.setCsvFileFieldSeparator(
                        (String) dataBrokerObject.get(DeployConstants.CSV_FILE_FIELD_SEPARATOR));
                  }
                  if (dataBrokerObject.get(DeployConstants.MAP_INPUTS) != null) {
                    MapInputs mapInputBean = new MapInputs();
                    mapInputArray = (JSONArray) dataBrokerObject.get(DeployConstants.MAP_INPUTS);
                    ...
                    while (itr5.hasNext()) {
                      ...
                      while (itr6.hasNext()) {
                        ...
                        if (key != null && key.equalsIgnoreCase(DeployConstants.INPUT_FIELD)) {
                          JSONObject inputFieldJsonObject = (JSONObject) pair.getValue();
                          if (inputFieldJsonObject != null) {
                            if (inputFieldJsonObject.get(DeployConstants.NAME) != null) {
                              inputFieldBean.setName(
                                  (String) inputFieldJsonObject.get(DeployConstants.NAME));
                            }
                            if (inputFieldJsonObject.get(DeployConstants.TYPE) != null) {
                              inputFieldBean.setType(
                                  (String) inputFieldJsonObject.get(DeployConstants.TYPE));
                            }
                            if (inputFieldJsonObject.get(DeployConstants.CHECKED) != null) {
                              inputFieldBean.setChecked(
                                  (String) inputFieldJsonObject.get(DeployConstants.CHECKED));
                            }
                            if (inputFieldJsonObject.get(DeployConstants.MAPPED_TO_FIELD) != null) {
                              inputFieldBean.setMappedToField(
                                  (String)
                                      inputFieldJsonObject.get(DeployConstants.MAPPED_TO_FIELD));
                            }
                          }
                        }
                      }
                  ...
                  if (dataBrokerObject.get(DeployConstants.MAP_OUTPUTS) != null) {
                    MapOutputs mapOutputBean = new MapOutputs();
                    mapoutputArray = (JSONArray) dataBrokerObject.get(DeployConstants.MAP_OUTPUTS);
                    ...
                    while (itr7.hasNext()) {
                      ...
                      while (itr8.hasNext()) {
                        ...
                        log.debug("Key  " + key);
                        log.debug("value " + pair.getValue());
                        if (key != null && key.equalsIgnoreCase(DeployConstants.OUTPUT_FIELD)) {
                          JSONObject outputFieldJsonObject = (JSONObject) pair.getValue();
                          if (outputFieldJsonObject != null) {
                            if (outputFieldJsonObject.get(DeployConstants.TAG) != null) {
                              outputFieldBean.setTag(
                                  (String) outputFieldJsonObject.get(DeployConstants.TAG));
                            }
                            if (outputFieldJsonObject.get(DeployConstants.NAME) != null) {
                              outputFieldBean.setName(
                                  (String) outputFieldJsonObject.get(DeployConstants.NAME));
                            }
                            if (outputFieldJsonObject.get(
                                    DeployConstants.TYPE_AND_ROLE_HIERARCHY_LIST)
                                != null) {
                              ArrayList<TypeAndRoleHierarchyList> roleHirerachryList =
                                  new ArrayList<TypeAndRoleHierarchyList>();
                              JSONArray hierarchyListArray =
                                  (JSONArray)
                                      outputFieldJsonObject.get(
                                          DeployConstants.TYPE_AND_ROLE_HIERARCHY_LIST);
                              if (hierarchyListArray != null) {
                                ...
                                while (itr9.hasNext()) {
                                  ...
                                  TypeAndRoleHierarchyList typeAndRoleHierarchyListBean =
                                      new TypeAndRoleHierarchyList();
                                  while (itr10.hasNext()) {
                                    ...
                                    if (keyVal != null) {
                                      if (keyVal.equalsIgnoreCase(DeployConstants.NAME)) {
                                        typeAndRoleHierarchyListBean.setName(
                                            (String) mapPair.getValue());
                                      }
                                      if (keyVal.equalsIgnoreCase(DeployConstants.ROLE)) {
   ...
   */
  public Blueprint jsonFileToObject(String jsonFile, DataBrokerBean dataBrokerBean)
      throws Exception {
    ...
    try {
      ...
      String name = (String) jo.get(DeployConstants.NAME);
      String version = (String) jo.get(DeployConstants.VERSION);
      ...
      JSONArray inputPorts = (JSONArray) jo.get(DeployConstants.INPUT_PORTS);
      ...
      if (inputPorts != null) {
        ...
        while (itr2.hasNext()) {
          ...
          while (itr1.hasNext()) {
            ...
            if (key != null && key.equalsIgnoreCase(DeployConstants.OPERATION_SIGNATURE)) {
              JSONObject jsonObject = (JSONObject) pair.getValue();
              String operationName = (String) jsonObject.get(DeployConstants.OPERATION_NAME);
              operationSignature.setOperationName(operationName);
              inputPortObj.setOperationSignature(operationSignature);
            }
            if (key != null && key.equalsIgnoreCase(DeployConstants.CONTAINER_NAME)) {
      ...
      if (nodes != null) {
        ...
        while (itr3.hasNext()) {
          ...
          while (itr1.hasNext()) {
            ...
            if (pair != null && pair.getKey() != null && pair.getValue() != null) {
              String key = (String) pair.getKey();
              if (key != null && key.equalsIgnoreCase(DeployConstants.OPERATION_SIGNATURE_LIST)) {
                ...
                if (key != null && key.equalsIgnoreCase(DeployConstants.IMAGE)) {
                ...
                if (key != null && key.equalsIgnoreCase(DeployConstants.PROTO_URI)) {
                  node.setProtoUri((String) pair.getValue());
                }
                JSONObject dataBrokerObject = null;
                if (key != null && key.equalsIgnoreCase(DeployConstants.DATA_BROKER_MAP)) {
   ...
   */
  public ArrayList<OperationSignatureList> jsonArrayParseObjectProb(
      Object obj, ArrayList<OperationSignatureList> listComponent) {
    ...
    while (itr.hasNext()) {
      ...
      while (itr1.hasNext()) {
        ...
        if (key != null && key.equalsIgnoreCase(DeployConstants.CONNECTED_TO)) {
          ...
          while (conItr.hasNext()) {
            ...
            while (itr3.hasNext()) {
              ...
              if (connectedKey != null
                  && connectedKey.equalsIgnoreCase(DeployConstants.CONTAINER_NAME)) {
              ...
              if (connectedKey != null
                  && connectedKey.equalsIgnoreCase(DeployConstants.OPERATION_SIGNATURE)) {
                JSONObject objVar = (JSONObject) pair1.getValue();
                OperationSignature opr = new OperationSignature();
                if (objVar != null) {
                  String operation = (String) objVar.get(DeployConstants.OPERATION_NAME);
        ...
        if (key != null && key.equalsIgnoreCase(DeployConstants.OPERATION_SIGNATURE)) {
          ...
          if (objVar != null) {
            String oprName = (String) objVar.get(DeployConstants.OPERATION_NAME);
            if (oprName != null && !"".equals(oprName)) {
              oprSignature.setOperationName(oprName);
            }

            String inputMessage = (String) objVar.get(DeployConstants.INPUT_MESSAGE_NAME);
            if (inputMessage != null && !"".equals(inputMessage)) {
              oprSignature.setInputMessageName(inputMessage);
            }

            String outputMessage = (String) objVar.get(DeployConstants.OUTPUT_MESSAGE_NAME);
      ...
      if (nodes != null) {
        ...
        while (itr3.hasNext()) {
          ...
          if (containerName != null
              ...
              && !nodeType.equalsIgnoreCase("Splitter")
  ...
  public LinkedList<String> getSequenceListFromJSON(String jsonString) throws Exception {
    ...
    try {
      NodeTree<String> root = new NodeTree<String>(DeployConstants.BLUEPRINT_CONTAINER);
      Object obj = new JSONParser().parse(new StringReader(jsonString));
      JSONObject jo = (JSONObject) obj;
      JSONArray nodes = (JSONArray) jo.get(DeployConstants.NODES);
   ...
   */
  public void sequenceJsonParseProbe(
      Object obj, NodeTree<String> newNode, NodeTree<String> rootNode) {
    ...
    while (itr.hasNext()) {
      ...
      while (itr1.hasNext()) {
        ...
        if (pair.getKey() != null
            && pair.getKey().equals(DeployConstants.CONNECTED_TO)
            && pair.getValue() != null) {
  ...
  public boolean checkProbeIndicator(String jsonString) throws Exception {
    ...
    try {
      Object obj = new JSONParser().parse(new StringReader(jsonString));
      JSONObject jo = (JSONObject) obj;
      JSONArray probeIndicator = (JSONArray) jo.get(DeployConstants.PROBE_INDICATOR);
      if (probeIndicator == null) {
        probeIndicator = (JSONArray) jo.get(DeployConstants.PROBE_INDOCATOR);
      }
      if (probeIndicator != null) {
  ...
  public String getSolutionName(String jsonFile) throws Exception {
    log.debug("getSolutionName Start");
    String name = null;
    try {
      Object obj = new JSONParser().parse(new StringReader(jsonFile));
      JSONObject jo = (JSONObject) obj;
      String prettyJSONString = jo.toString();
      name = (String) jo.get(DeployConstants.NAME);
    } catch (Exception e) {
      log.error("getSolutionName failed", e);
      throw e;
    }
    log.debug("getSolutionName End");
    return name;
  }

  public String getSolutionVersion(String jsonFile) throws Exception {
    log.debug("getSolutionVersion Start");
    String version = null;
    try {
      Object obj = new JSONParser().parse(new StringReader(jsonFile));
      JSONObject jo = (JSONObject) obj;
      String prettyJSONString = jo.toString();
      version = (String) jo.get(DeployConstants.VERSION);
    } catch (Exception e) {
      log.error("checkProbeIndicator failed", e);
      throw e;
    }
    log.debug("getBlueprintDetail End");
    return version;
  }



  public static CommonDataServiceRestClientImpl getClient(
